...
int main(int argc, char **argv)
{
  ...
  if(argc==1)
    {
      listname  = "/home/cy7423/eic/DIS_files/DIS_lists/DIS_25.10_18x275_3.11.list"; //"test.list";
      outname = "/home/cy7423/eic/DIS_files/DIS_25.10_18x275_3.11.root"; //"test.root";
    }
  ...
  // number of hits for track reconstruction
  TTreeReaderArray<unsigned int> nMeasurements = {treereader, "CentralCKFTrajectories.nMeasurements"};
   ...
   TFile *file_signal = new TFile("/home/cy7423/eic/DIS_files/Signal_DIS_25.10_18x275_3.11.root", "RECREATE"); //SignalD0.root
  ...
  TFile *file_bkg = new TFile("/home/cy7423/eic/DIS_files/Bkg_DIS_25.10_18x275_3.11.root", "RECREATE"); //BkgD0.root
